...
async function getStats() {
    try {
        ...
        return [
            { label: "Total Users", value: "0", icon: Users, color: "text-blue-600", bg: "bg-blue-100 dark:bg-blue-900/30" },
            { label: "Admin Accounts", value: "0", icon: TrendingUp, color: "text-emerald-600", bg: "bg-emerald-100 dark:bg-emerald-900/30" },
            { label: "Active Sessions", value: "0", icon: Car, color: "text-purple-600", bg: "bg-purple-100 dark:bg-purple-900/30" },
            { label: "System Alerts", value: "0", icon: AlertCircle, color: "text-red-600", bg: "bg-red-100 dark:bg-red-900/30" },
        ];
    }
